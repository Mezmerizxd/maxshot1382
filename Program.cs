...
class Program
{
    static void Main(string[] args)
    {
        ...
        if (args.Length < 7)
        {
            Console.WriteLine("Usage: maxshot1382.exe <screenWidth> <screenHeight> <imageWidth> <imageHeight> <imageName> <offsetX> <offsetY>");
            return;
        }
        ...
        SaveAsPng(screenshot, imageName + ".webp");

        Console.WriteLine("Screenshot saved as " + imageName + ".webp");
    }
